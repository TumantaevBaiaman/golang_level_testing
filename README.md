Тестовые задания. Цель данных заданий понять ваш текущий уровень владения базовыми инструментами и способность самостоятельно решать поставленную задачу.
